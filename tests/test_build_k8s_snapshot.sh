...
{
  build --fresh "${my_dir}/fixtures/one-repo-fresh-facts.json"
  assert_status_0
...
{
  build --current "${my_dir}/fixtures/one-repo-current-snapshot.json"
  assert_status_0
  assertEquals "artifact count"    "1" "$(jq '.artifacts | length' "${stdoutF}")"
...
{
  build --current "${my_dir}/fixtures/two-repo-current-snapshot.json" \
        --fresh   "${my_dir}/fixtures/one-repo-fresh-facts.json"
  assert_status_0
...
{
  build --current "${my_dir}/fixtures/current-snapshot-with-exited-artifact.json"
  assert_status_0
  assertEquals "artifact count" "1" "$(jq '.artifacts | length' "${stdoutF}")"
...
{
  build --fresh "${my_dir}/fixtures/bad-digest-fresh-facts.json"
